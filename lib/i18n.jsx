...
const STRINGS = {
  en: {
    ...
    museum_room: 'Room',
    museum_hint_desktop: '⌨️ ‹ › move along the rail · drag to look · Enter inspect · Esc back',
    museum_hint_mobile: 'Tap left/right to move · drag to look · tap a piece to inspect',
  ...
  es: {
    ...
    museum_room: 'Sala',
    museum_hint_desktop: '⌨️ ‹ › moverse por el raíl · arrastrar para mirar · Enter inspeccionar · Esc volver',
    museum_hint_mobile: 'Toca izquierda/derecha para moverte · arrastra para mirar · toca una pieza para inspeccionar',
