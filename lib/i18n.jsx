...
const STRINGS = {
  en: {
    ...
    view_all: 'View all',
    rooms_label: 'Museum rooms',
    pieces: 'pieces',
    piece: 'piece',
    entrance_hint: '⌨️ ‹ › showcase · ↓ rooms · Enter to enter',
    deck_hint: '⌨️ ‹ › minis · ↑↓ photos · Enter details · Esc entrance',
    swipe_hint: 'Swipe to browse · tap the photo for details',
    back_to_entrance: '← Entrance',
    museum_title: 'Museum',
    museum_enter: 'Enter the museum',
    museum_skin: 'Skin',
    museum_skin_dungeon: 'Dungeon',
    museum_skin_matrix: 'Matrix',
    museum_move: 'Move',
    museum_move_rail: 'Rail',
    museum_move_walk: 'Walk',
    museum_room: 'Room',
    museum_hint_desktop: '⌨️ ‹ › move · drag to look · hold Space to zoom · double-click to keep it open · Esc back',
    museum_hint_mobile: 'Tap left/right to move · drag to look · double-tap a piece to zoom',
    museum_hint_walk: '⌨️ W A S D walk · shift to run · drag to steer · Esc leave',
    museum_exit: 'Leave the museum',
    museum_room_prev: 'Previous room',
    museum_room_next: 'Next room',
    museum_prev: 'Previous piece',
    museum_next: 'Next piece',
    museum_empty_board: 'Empty board',
    museum_empty_board_note: 'This room has fewer pieces than slots, so the layout pads the rest.',
    museum_open_detail: 'Open detail page →',
    museum_loading: 'Lighting the halls…',
    museum_no_webgl: 'Your browser can’t show the 3D museum — view this room in 2D →',
    museum_images: 'images',
    museum_pieces: 'pieces',
  },
  es: {
    nav_gallery: 'Galería',
    ...
    view_all: 'Ver todo',
    rooms_label: 'Salas del museo',
    pieces: 'piezas',
    piece: 'pieza',
    entrance_hint: '⌨️ ‹ › vitrina · ↓ salas · Enter para entrar',
    deck_hint: '⌨️ ‹ › minis · ↑↓ fotos · Enter detalles · Esc entrada',
    swipe_hint: 'Desliza para explorar · toca la foto para ver detalles',
    back_to_entrance: '← Entrada',
    museum_title: 'Museo',
    museum_enter: 'Entrar al museo',
    museum_skin: 'Ambientación',
    museum_skin_dungeon: 'Mazmorra',
    museum_skin_matrix: 'Matrix',
    museum_move: 'Movimiento',
    museum_move_rail: 'Raíl',
    museum_move_walk: 'Caminar',
    museum_room: 'Sala',
    museum_hint_desktop: '⌨️ ‹ › moverse · arrastrar para mirar · mantén Espacio para ampliar · doble clic para fijarlo · Esc volver',
    museum_hint_mobile: 'Toca izquierda/derecha para moverte · arrastra para mirar · doble toque para ampliar',
    museum_hint_walk: '⌨️ W A S D para andar · shift para correr · arrastra para girar · Esc para salir',
    museum_exit: 'Salir del museo',
    museum_room_prev: 'Sala anterior',
    museum_room_next: 'Sala siguiente',
    museum_prev: 'Pieza anterior',
    museum_next: 'Pieza siguiente',
    museum_empty_board: 'Panel vacío',
    museum_empty_board_note: 'Esta sala tiene menos piezas que espacios, así que el resto queda relleno.',
    museum_open_detail: 'Abrir página de detalle →',
    museum_loading: 'Encendiendo las salas…',
    museum_no_webgl: 'Tu navegador no puede mostrar el museo 3D — ver esta sala en 2D →',
    museum_images: 'imágenes',
    museum_pieces: 'piezas',
  },
};
