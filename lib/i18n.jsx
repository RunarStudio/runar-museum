...
const STRINGS = {
  en: {
    ...
    museum_room: 'Room',
    museum_hint_desktop: '⌨️ ‹ › move along the rail · drag to look · Enter inspect · double-click to zoom · Esc back',
  ...
  es: {
    ...
    museum_room: 'Sala',
    museum_hint_desktop: '⌨️ ‹ › moverse por el raíl · arrastrar para mirar · Enter inspeccionar · doble clic para ampliar · Esc volver',
